...
**2,920 events · 725 distinct publishers · 2025-07-01 to 2026-09-20**
...
|------|------|-------------|
| `data/ai-timeline.csv` | 2,920 | Full dataset, CSV with header |
| `data/ai-timeline.json` | 2,920 | Same data as a JSON array |
