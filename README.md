...
**2,950 events · 737 distinct publishers · 2025-07-01 to 2026-09-21**
...
|------|------|-------------|
| `data/ai-timeline.csv` | 2,950 | Full dataset, CSV with header |
| `data/ai-timeline.json` | 2,950 | Same data as a JSON array |
