...
**3,106 events · 795 distinct publishers · 2025-07-01 to 2026-09-26**
...
|------|------|-------------|
| `data/ai-timeline.csv` | 3,106 | Full dataset, CSV with header |
| `data/ai-timeline.json` | 3,106 | Same data as a JSON array |
