...
**3,112 events · 798 distinct publishers · 2025-07-01 to 2026-09-26**
...
|------|------|-------------|
| `data/ai-timeline.csv` | 3,112 | Full dataset, CSV with header |
| `data/ai-timeline.json` | 3,112 | Same data as a JSON array |
