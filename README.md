...
**3,013 events · 769 distinct publishers · 2025-07-01 to 2026-09-23**
...
|------|------|-------------|
| `data/ai-timeline.csv` | 3,013 | Full dataset, CSV with header |
| `data/ai-timeline.json` | 3,013 | Same data as a JSON array |
