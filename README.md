...
**2,947 events · 734 distinct publishers · 2025-07-01 to 2026-09-21**
...
|------|------|-------------|
| `data/ai-timeline.csv` | 2,947 | Full dataset, CSV with header |
| `data/ai-timeline.json` | 2,947 | Same data as a JSON array |
