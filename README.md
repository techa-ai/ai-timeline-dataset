...
**2,963 events · 741 distinct publishers · 2025-07-01 to 2026-09-22**
...
|------|------|-------------|
| `data/ai-timeline.csv` | 2,963 | Full dataset, CSV with header |
| `data/ai-timeline.json` | 2,963 | Same data as a JSON array |
