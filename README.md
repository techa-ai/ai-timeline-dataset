...
**3,043 events · 778 distinct publishers · 2025-07-01 to 2026-09-24**
...
|------|------|-------------|
| `data/ai-timeline.csv` | 3,043 | Full dataset, CSV with header |
| `data/ai-timeline.json` | 3,043 | Same data as a JSON array |
