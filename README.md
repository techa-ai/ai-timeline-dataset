...
**2,933 events · 727 distinct publishers · 2025-07-01 to 2026-09-21**
...
|------|------|-------------|
| `data/ai-timeline.csv` | 2,933 | Full dataset, CSV with header |
| `data/ai-timeline.json` | 2,933 | Same data as a JSON array |
