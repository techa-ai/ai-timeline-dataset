...
**3,008 events · 762 distinct publishers · 2025-07-01 to 2026-09-23**
...
|------|------|-------------|
| `data/ai-timeline.csv` | 3,008 | Full dataset, CSV with header |
| `data/ai-timeline.json` | 3,008 | Same data as a JSON array |
