...
**3,088 events · 790 distinct publishers · 2025-07-01 to 2026-09-25**
...
|------|------|-------------|
| `data/ai-timeline.csv` | 3,088 | Full dataset, CSV with header |
| `data/ai-timeline.json` | 3,088 | Same data as a JSON array |
